  ...
  <div>
    ...
    <div class="navbar">
        ...
        <div class="navbar-menu-container">
            ...
            <a href="javascript:void(0)" class="navbar-link" @click="loginModalFlag=true" v-if="!isLogin" >Login</a>
            <a href="javascript:void(0)" class="navbar-link" v-if="isLogin" @click="logout" >Logout</a>
            <div class="navbar-cart-container">
            <span class="navbar-cart-count" v-if="getInitCartCount>0">{{getInitCartCount}}</span>
            <a class="navbar-link navbar-cart-link" href="javascript:;" @click="clickCartIsLogin">
    ...
    login(){
      ...
      this.$http({
        ...
        if(res.status == ERR_OK){
          ...
          this.nickName = this.getUserInfo.userName;
          this.isLogin = true;
          this.loginModalFlag = false;

          // 访问getCartCount接口设置cartCount信息
          this.cartCount();
        }else{
          this.errorTip = true;
        }
