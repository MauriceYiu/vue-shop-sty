<template>
  <div>
        ...
        <div class="cart">
            ...
            <div class="cart-foot-inner">
                ...
                <div class="item-all-check">
                    <a href="javascipt:;">
                        <span class="checkbox-btn item-check-btn" :class="{'check':checkedAll}" @click="checkAll">
    ...
    <Modal :mdShow="delCartSuc" @close="closeSucModal">
  ...
  methods: {
    ...
    editCart(flag, item) {
      if (flag == "checked") {
        ...
        // if(item.checked == '0'){
        //   this.setCartCount(-parseInt(item.productNum));
        // }else{
        //   this.setCartCount(parseInt(item.productNum));
        // }
      } else if (flag == "add") {
